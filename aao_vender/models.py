...
class Vender_Details(models.Model):
    ...
    vd_aao_balance = models.FloatField( default=0, null=True)
    vd_plan_subscribe = models.TextField(max_length=200, default=None, null=True)
    vd_per_user_price = models.FloatField( default=100, null=True)
...
class Aoo_User_Order_Details(models.Model):
    ...
    auod_subsc_package_name = models.TextField(max_length=100, default=None)
